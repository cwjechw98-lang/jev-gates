...
export function decideCompletion({
  ...
  if (status === STATUS.done && judgeStatus === 'not_requested' && criteria.some((c) => c.kind === 'semantic')) {
    status = STATUS.unverified;
    push(REASON.judgeUnavailable, 'semantic criteria exist but no judge was consulted');
  }
